...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT AdminEmail FROM admin WHERE AdminEmail=:AdminEmail and UserName=:UserName";
...
if($query -> rowCount() > 0)
{
$con="update admin set Password=:newpassword where AdminEmail=:AdminEmail and MobileNumber=:mobile";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':AdminEmail', $AdminEmail, PDO::PARAM_STR);
...
<div class="col-md-12">
<h4 class="header-line">Admin Password Recovery</h4>
</div>
</div>
